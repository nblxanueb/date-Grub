          ...
          <div className="search-options">
            <div className="type">
              ...
              <button className={`restaurant-type ${this.state.active === 3 ? "active" : ""}`} onClick={() => {
                ...
                <img src={dinner} className="dinner" alt="dinner" />
              </button>
            </div>
            <br />
            <div className="options">
              <div className="price-range">
                <button className="dollar-sign1" onClick={this.set1}>
                  $
                </button>
                <button className="dollar-sign2" onClick={this.set2}>
                  $$
                </button>
                <button className="dollar-sign3" onClick={this.set3}>
                  $$$
                </button>
                <button className="dollar-sign4" onClick={this.set4}>
                  $$$$
                </button>
              </div>
              <selectMenu />
            ...
            <button className="search" onClick={this.onSubmit}>
              <img src={search} className="loupe" alt="search" />
            </button>
          </div>
